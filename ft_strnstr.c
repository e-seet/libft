...
int main() {
    // Test case 1: Search for a substring present in the string within the specified length
    const char *haystack1 = "Hello, World!";
    const char *needle1 = "World";
    size_t max_length1 = 12;  // Limit the search to the first 12 characters
    ...
    // Test case 2: Search for a substring present in the string within the specified length
    // Test case fail.
    const char *haystack2 = "Hello, World!";
    const char *needle2 = "World";
    size_t max_length2 = 10;  // Limit the search to the first 10 characters
    ...
    // Test case 3: Search for a substring not present in the string within the specified length
    // fail as it does not exist
    const char *haystack3 = "This is a test.";
    const char *needle3 = "foobar";
    size_t max_length3 = 15;  // Limit the search to the first 15 characters
    ...
    size_t max_length4 = 10;  // Limit the search to the first 12 characters
